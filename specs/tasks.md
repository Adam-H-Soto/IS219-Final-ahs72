...
- [x] **T-34** — Stat tile content: "50 States analyzed", "2 Deployed projects", "∞ Opinions on chocolate", "0 Willingness to be nonchalant" → CR-05, Design §5
- [x] **T-35** — Apply intentional margin-top offsets to stat tiles #2 (`1.5rem`) and #4 (`-0.75rem`) → Design §2.3
- [x] **T-36** — Write four about body paragraphs: identity, obsession/question, outside/chocolate, role aspiration → CR-06
